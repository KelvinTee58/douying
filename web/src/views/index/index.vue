<template>
  <div class="index-page">
    ...
    <div class="formInner" v-if="activeTabbar == 1">
      <workflowInner></workflowInner>
    </div>
    <div class="formInner" v-if="activeTabbar == 2">
      <formManage></formManage>
    </div>
    <van-tabbar v-model="activeTabbar">
      <van-tabbar-item icon="home-o">主页</van-tabbar-item>
      <van-tabbar-item icon="cluster-o">工作流</van-tabbar-item>
...
import workflowInner from './components/workflow.vue';
import formManage from './components/manage.vue';
import { Tabbar, TabbarItem } from 'vant';

export default {
  name: 'index-indexPages',
