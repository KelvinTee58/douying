<template>
  <div class="components-card-employeeCard">
    <div class="card" :class="{ selected: isSelected }">
      <div class="card-image">
        <!-- 替换成随机图片 -->
        <!-- <img src="https://picsum.photos/400/400" alt="Random Hotel Image" /> -->
        <i class="ri-user-5-line remixicon"></i>
      </div>
      <div class="card-info">
        <div class="card-footer">
          <span class="card-price">
            <h2 class="card-title">{{ value.name || '员工名称' }}</h2>
          </span>
...
export default {
  ...
  name: 'components-card-employeeCard',
  props: {
    value: {
      type: Object,
      default: () => {}
